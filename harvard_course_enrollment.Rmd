...
# Subsetting the joint dataset for courses that were in the same department in both years
...
# Renaming departments to be concise and consist
...
# Grouping by department and calculating the total number of students who took classes in the departments each year 
...
# Filtering for departments where the total number of students who enrolled in their courses is greater than 50 in 2018 and 2019
...
# Creating a new variable for the percent change in enrollment from Spring 2018 - Spring 2019 
...
# The coloured fill of the bars corresponds to the size of the department (total number of students enrolled in its courses) in 2019
...
# Adding a solid vertical line at the 0% change in enrollment mark and a dashed horizontal line that delineates between the top and bottom 8
  
  geom_hline(yintercept = 0, colour = "black", size = 0.5) +
  geom_vline(xintercept = 8.5, colour = "black", linetype = "dotted") +

# Filling in the top and bottom halves of the graph in different colours to further delineate between the top and bottom results
...
# Changing the axes labels and adding a caption, title, and subtitle
  
  labs(y = "Percent Change in Course Enrollment",
       x = "Department",
       caption = "\n *Departments where a total of 50+ students took their courses in Spring 2018 & 2019
